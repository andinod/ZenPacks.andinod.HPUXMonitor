...
from ZenPacks.andinod.HPUXMonitor.interfaces import IHPUXDeviceInfo
...
class HPUXDeviceInfo(DeviceInfo):
    implements(IHPUXDeviceInfo)

    uptime = ProxyProperty("uptime")
